...
; Notes:
;
;   We use a SMALL memory model because we pass segment addresses as 
;   explicit WORD parameters (e.g., 0xA000 for VGA memory) and manually 
;   set ES via MOV ES, segment_value. The entire library code fits in one 
;   code segment, and the data segment only holds 4 clip variables.
;
; Change Log:
;
; - Version 1.1
